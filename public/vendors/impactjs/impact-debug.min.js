...
if(dependenciesLoaded&&m.body){ig._loadQueue.splice(i,1);m.loaded=true;m.body();if(console&&console.log){console.log("[impactjs] loaded & defined module: "+m.name);}
...
// lib/game/dummy.js
ig.baked=true;ig.module('game.dummy').requires('impact.animation','impact.background-map','impact.collision-map','impact.entity','impact.entity-pool','impact.font','impact.game','impact.image','impact.impact','impact.input','impact.loader','impact.map','impact.sound','impact.system','impact.timer','impact.debug.debug','impact.debug.entities-panel','impact.debug.graph-panel','impact.debug.maps-panel','impact.debug.menu').defines(function(){if(console&&console.log){console.log('[impactjs] heeloo');}});